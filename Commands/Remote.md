# git remote
When working with git, a **remote** is any repository that is not on the machine that you are working on. The counterpart to this is **local**, or the machine that is being developed on.
